...
const migrations=[1,2,3,4,5].map((number)=>readFileSync(resolve(process.cwd(),"db/migrations",
  `20260804000${number}_${["downtown_u_phase1","downtown_u_webhook_events","downtown_u_payment_activation","downtown_u_refund_activation","downtown_u_auth"][number-1]}.sql`),"utf8"));

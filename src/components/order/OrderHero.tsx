import { Clock, MapPin, Phone, Sparkles, BadgeDollarSign } from "lucide-react";
    ...
    <section className="relative pt-20 overflow-hidden" data-testid="order-hero">
      ...
      <div className="relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 sm:py-24 text-center">
          ...
          <p className="text-cream/60 text-sm sm:text-base md:text-lg max-w-2xl mx-auto mb-6 sm:mb-10 fade-in-slow leading-relaxed px-2">
            Order direct from Proper Cuisine — skip the third-party markup, support the
            kitchen, and unlock loyalty perks coming soon.
          </p>

          {/* Benefit Chips — direct-order advantages */}
          <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 fade-in-slow px-2 mb-5 sm:mb-7">
            <div className="flex items-center gap-2 bg-gold/10 border border-gold/30 rounded-full px-4 py-2 sm:px-5 sm:py-2.5 backdrop-blur-sm">
              <BadgeDollarSign className="w-4 h-4 text-gold shrink-0" />
              <span className="text-gold text-xs sm:text-sm font-medium">
                No third-party fees — save 15–30% vs DoorDash
              </span>
            </div>
            <div className="flex items-center gap-2 bg-gold/10 border border-gold/30 rounded-full px-4 py-2 sm:px-5 sm:py-2.5 backdrop-blur-sm">
              <Sparkles className="w-4 h-4 text-gold shrink-0" />
              <span className="text-gold text-xs sm:text-sm font-medium">
                Earn Proper Rewards (coming soon)
              </span>
            </div>
          </div>
